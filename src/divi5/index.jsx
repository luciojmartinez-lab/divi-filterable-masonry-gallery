...
import gridMetadata from '../../modules-json/filterable-grid-gallery/module.json';
import gridDefaultAttrs from '../../modules-json/filterable-grid-gallery/module-default-render-attributes.json';
import gridDefaultPrintedStyleAttrs from '../../modules-json/filterable-grid-gallery/module-default-printed-style-attributes.json';
...
addAction('divi.moduleLibrary.registerModuleLibraryStore.after', 'dfmg/filterable-masonry-gallery', () => {
	...
	registerModule(gridMetadata, {
		defaultAttrs: gridDefaultAttrs,
		defaultPrintedStyleAttrs: gridDefaultPrintedStyleAttrs,
		renderers: {
			edit: GalleryEdit
		}
	});
