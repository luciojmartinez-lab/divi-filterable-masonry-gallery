...
- Native Divi 5 uniform grid module for filterable, lightbox-ready image grids.
...
```powershell
Compress-Archive -Path .\divi-filterable-masonry-gallery -DestinationPath .\divi-filterable-masonry-gallery-1.3.11.zip -Force
```
